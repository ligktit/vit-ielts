...
export function PageLogin({ loginConfig: _loginConfig }: PageLoginProps) {
  ...
  return (
    ...
    >
      ...
      >
        {/* Green bleed — fills left half of viewport edge-to-edge */}
        ...
        <div className="absolute inset-y-0 left-0 w-1/2 overflow-hidden pointer-events-none z-[1]" aria-hidden="true">
          <div className="absolute right-[-40px] top-[-104px] w-[360px] h-[360px] rounded-full bg-white/25" />
          <div className="absolute left-[-100px] bottom-[-20px] w-[251px] h-[251px] rounded-full bg-white/25" />
        </div>
