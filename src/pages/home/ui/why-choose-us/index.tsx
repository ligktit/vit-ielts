...
const StatCard = ({
  ...
  <div className="group relative w-full sm:w-[350px] h-[200px] rounded-[100px] overflow-hidden shadow-[0_12px_40px_rgba(0,0,0,0.06)] bg-white flex items-center transition-all duration-300 hover:-translate-y-2 hover:shadow-[0_20px_50px_rgba(0,0,0,0.12)] border border-gray-50/50 cursor-default">
...
export const WhyChooseUs = ({ config }: WhyChooseUsProps) => {
  // Use config as fallback if provided, but default to Figma specs text
  const badgeText = config?.badge?.text || "Tại sao là chúng tôi?";
  const titleText =
  ...
  return (
    <div data-section="why-choose-us" className="bg-white py-16 lg:py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12 xl:gap-16">
          ...
          <div className="flex-1 flex flex-col items-center text-center max-w-2xl mx-auto order-first lg:order-none mb-8 lg:mb-0">
            {/* Badge */}
            <div className="inline-flex items-center justify-center px-6 py-2 bg-[#C3D4FF] text-[#5281F9] text-sm font-bold rounded-[12px] mb-8 uppercase tracking-wide">
              {badgeText}
            </div>
